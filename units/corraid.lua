unitDef = {
  ...
  customParams           = {
	...
	helptext_pl    = [[Drogi, lecz potezny, Ravager jest w stanie samemu poradzic sobie z wiekszoscia przeciwnikow. Chociaz jego zwrotnosc jest bardzo niska, ma wysoka predkosc maksymalna, dzieki czemu jest w stanie dogonic i zniszczyc lzejsze jednostki. Jego dzialo moze strzelac nad przeszkodami, na przyklad wrakami lub innymi czolgami. Duze grupy Ravagerow mozna skutecznie niszczyc bombami.]],
	aimposoffset   = [[0 8 0]],
	midposoffset   = [[0 -2 0]],
	modelradius    = [[21]],
  },
