unitDef = {
  ...
  customParams           = {
    description_bp = [[Tanque de construç?o armado, contrói a 7.5 m/s]],
	...
	description_pl = [[Uzbrojony czolg konstruktor, moc 7.5 m/s]],
	...
	helptext_pl    = [[Welder jest bardzo wytrzymaly, a jego uzbrojenie pozwala mu bronic sie przed lekkimi jednostkami.]],
	aimposoffset   = [[0 0 0]],
	midposoffset   = [[0 -10 0]],
	modelradius    = [[30]],
  },
