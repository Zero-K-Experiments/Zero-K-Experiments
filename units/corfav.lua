unitDef = {
  ...
  customParams           = {
	...
	description_pl = [[Pojazd zwiadowczy]],
	...
	helptext_pl    = [[Tani i szybki, Dart stanowi duze zagrozenie na poczatku gry w wypadku zaskoczenia przeciwnika. Latwo go powstrzymac podstawowymi wiezyczkami lub predkimi jednostkami.]],
	modelradius    = [[7]],
  },
